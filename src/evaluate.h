...
// Pawns get bonuses for marching forward towards Rank 8
...
// Knights want to be in the center
...
// King desperately wants to castle into the corners of Rank 1
const int king_pst[64] = {
    ...
    -30,-40,-40,-50,-50,-40,-40,-30  // Rank 8 (Terrible penalty, do not walk here!)
};
